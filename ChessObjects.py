...
class Spot(object):
    ...
    def __eq__(self, spot):
        return self.row == spot.row and self.col == spot.col
...
class Move(object):
    def __init__(self, start: Spot, end: Spot, is_castling=False, is_promoted=False, is_en_passant=False):
    ...
    def __eq__(self, move):
        ...
        flag_2 = (self.is_castling==move.is_castling) and (self.is_promoted==move.is_promoted) and \
            (self.is_en_passant==move.is_en_passant)
